...
public class TuleapJsonParserTest {
	...
	public void testDeserializeProject0() {
		...
		TuleapProject tuleapProject = parser.parseProject(project0);
	...
	public void testDeserializeProject1() {
		...
		TuleapProject tuleapProject = parser.parseProject(project1);
		assertNotNull(tuleapProject);
	...
	public void testDeserializeProject2() {
		...
		TuleapProject tuleapProject = parser.parseProject(project2);
		assertNotNull(tuleapProject);
	...
	public void testDeserializeProject3() {
		...
		TuleapProject tuleapProject = parser.parseProject(project3);
		assertNotNull(tuleapProject);
	...
	public void testDeserializeProject4() {
		...
		TuleapProject tuleapProject = parser.parseProject(project4);
		assertNotNull(tuleapProject);
	...
	public void testDeserializeProjects() {
		...
		for (int i = 0; i < asJsonArray.size(); i++) {
			...
			TuleapProject tuleapProject = parser.parseProject(jsonElement);

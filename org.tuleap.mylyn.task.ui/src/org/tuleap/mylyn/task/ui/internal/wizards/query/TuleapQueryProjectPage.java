...
import org.tuleap.mylyn.task.ui.internal.wizards.TuleapProjectContentProvider;
import org.tuleap.mylyn.task.ui.internal.wizards.TuleapProjectLabelProvider;
...
public class TuleapQueryProjectPage extends AbstractRepositoryQueryPage2 {
	...
	protected void createPageContent(SectionComposite parent) {
		...
		topLevelPlanningButton.setText(TuleapUIMessages
				.getString(TuleapUIKeys.tuleapQueryProjectPageTopLevelPlanningButtonLabel));

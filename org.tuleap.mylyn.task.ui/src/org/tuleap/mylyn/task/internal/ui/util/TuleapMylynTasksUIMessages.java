 ...
 * @since 0.7
 */
public final class TuleapMylynTasksUIMessages {
	/** Qualified path to the properties file in which to seek the keys. */
	private static final String BUNDLE_NAME = "org.tuleap.mylyn.task.internal.ui.util.tuleap_mylyn_tasks_ui_messages"; //$NON-NLS-1$
	 ...
	 */
	private TuleapMylynTasksUIMessages() {

...
/**
 * JSON Resource for the {@code /api/<version>/milestone_types/:milestoneTypeId} URL.
 * 
 * @author <a href="mailto:stephane.begaudeau@obeo.fr">Stephane Begaudeau</a>
 */
public class RestMilestoneTypes extends AbstractAuthenticatedRestResource {
	 ...
	 */
	public RestMilestoneTypes(String serverUrl, String apiVersion, ICredentials credentials,
			int milestoneTypeId) {
	...
	protected String getUrl() {
		return URL.MILESTONE_TYPES + "/" + this.milestoneTypeId; //$NON-NLS-1$ 
	}

	/**
	 * Sends an GET request to the {@code /api/<version>/milestone_types/:milestoneTypeId} URL and returns the
	 * response.
	 * 
	 * @param headers
	...
	/**
	 * Sends an OPTIONS request to the {@code /api/<version>/milestone_types/:milestoneTypeId} URL and checks

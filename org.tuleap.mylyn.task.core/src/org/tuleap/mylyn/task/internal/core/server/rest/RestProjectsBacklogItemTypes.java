 ...
 */
public class RestProjectsBacklogItemTypes extends AbstractAuthenticatedRestResource {
	 ...
	 */
	protected RestProjectsBacklogItemTypes(String serverUrl, String apiVersion, ICredentials credentials,
			int projectId) {
	...
	protected String getUrl() {
		return URL.PROJECTS + "/" + projectId + URL.BACKLOG_ITEM_TYPES; //$NON-NLS-1$
	}

	/**
	 * Sends an GET request to the {@code /api/<version>/projects/:projectId/backlog_item_types} URL and
	...
	/**
	 * Sends an OPTIONS request to the {@code /api/<version>/projects/:projectId/backlog_item_types } URL and checks that

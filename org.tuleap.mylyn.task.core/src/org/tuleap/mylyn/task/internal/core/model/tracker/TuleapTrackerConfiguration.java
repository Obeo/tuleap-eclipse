 ...
 * @since 0.7
 */
public class TuleapTrackerConfiguration extends AbstractTuleapConfiguration {
	/**
	 ...
	 */
	public TuleapTrackerConfiguration(int identifier, String url, String label, String itemName,

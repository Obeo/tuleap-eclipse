...
public class TuleapRestConnector {
	 ...
	 * @param apiVersion
	 *            The version of the API using {@link ITuleapAPIVersions}
	 */
	public TuleapRestConnector(String serverURL, String apiVersion) {
		this.url = serverURL + API_PREFIX + apiVersion;
	}
	 ...
	 *            The data sent
	 */
	public void sendRequest(Resource resource, Map<String, String> headers, Object data) {
		// process the request
		ClientResource client = new ClientResource(this.url + "/projects/3/trackers/");

		switch (resource.getOperation()) {
			case OPTIONS:
				Request request = new Request(Method.GET, this.url + "/projects/3/trackers/");
	...
	public static void main(String[] args) {
		TuleapRestConnector connector = new TuleapRestConnector("http://localhost:3001", "v3.14");
		connector.sendRequest(Resource.API__OPTIONS, new HashMap<String, String>(), null);
	}
}

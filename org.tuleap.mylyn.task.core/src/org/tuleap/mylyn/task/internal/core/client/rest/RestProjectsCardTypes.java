 ...
 */
public class RestProjectsCardTypes extends AbstractAuthenticatedRestResource {
	 ...
	 */
	protected RestProjectsCardTypes(String serverUrl, String apiVersion, ICredentials credentials,
			int projectId) {
	...
	protected String getUrl() {
		return URL.PROJECTS + "/" + projectId + URL.CARD_TYPES; //$NON-NLS-1$
	}

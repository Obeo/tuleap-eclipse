...
public class FieldValue  implements java.io.Serializable {
    ...
    private org.tuleap.mylyn.task.internal.core.wsdl.soap.v2.FieldValueFileInfo[] file_info;

    private org.tuleap.mylyn.task.internal.core.wsdl.soap.v2.TrackerFieldBindValue[] bind_value;
    ...
    public FieldValue(
           ...
           org.tuleap.mylyn.task.internal.core.wsdl.soap.v2.FieldValueFileInfo[] file_info,
           org.tuleap.mylyn.task.internal.core.wsdl.soap.v2.TrackerFieldBindValue[] bind_value) {
           this.value = value;
     ...
     * @return file_info
     */
    public org.tuleap.mylyn.task.internal.core.wsdl.soap.v2.FieldValueFileInfo[] getFile_info() {
        return file_info;
    }
     ...
     * @param file_info
     */
    public void setFile_info(org.tuleap.mylyn.task.internal.core.wsdl.soap.v2.FieldValueFileInfo[] file_info) {
        this.file_info = file_info;
    }
     ...
     * @return bind_value
     */
    public org.tuleap.mylyn.task.internal.core.wsdl.soap.v2.TrackerFieldBindValue[] getBind_value() {
        return bind_value;
    }
     ...
     * @param bind_value
     */
    public void setBind_value(org.tuleap.mylyn.task.internal.core.wsdl.soap.v2.TrackerFieldBindValue[] bind_value) {
        this.bind_value = bind_value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://demo.tuleap.net/plugins/tracker/soap", "FieldValue"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://demo.tuleap.net/plugins/tracker/soap", "FieldValueFileInfo"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();

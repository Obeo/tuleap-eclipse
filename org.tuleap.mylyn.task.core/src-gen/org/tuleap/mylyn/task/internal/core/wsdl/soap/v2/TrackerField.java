...
public class TrackerField  implements java.io.Serializable {
    ...
    private org.tuleap.mylyn.task.internal.core.wsdl.soap.v2.TrackerFieldBindValue[] values;

    private org.tuleap.mylyn.task.internal.core.wsdl.soap.v2.TrackerFieldBindType binding;
    ...
    public TrackerField(
           ...
           org.tuleap.mylyn.task.internal.core.wsdl.soap.v2.TrackerFieldBindValue[] values,
           org.tuleap.mylyn.task.internal.core.wsdl.soap.v2.TrackerFieldBindType binding,
     ...
     * @return values
     */
    public org.tuleap.mylyn.task.internal.core.wsdl.soap.v2.TrackerFieldBindValue[] getValues() {
        return values;
    }
     ...
     * @param values
     */
    public void setValues(org.tuleap.mylyn.task.internal.core.wsdl.soap.v2.TrackerFieldBindValue[] values) {
        this.values = values;
    }


    /**
     * Gets the binding value for this TrackerField.
     * 
     * @return binding
     */
    public org.tuleap.mylyn.task.internal.core.wsdl.soap.v2.TrackerFieldBindType getBinding() {
        return binding;
    }


    /**
     * Sets the binding value for this TrackerField.
     * 
     * @param binding
     */
    public void setBinding(org.tuleap.mylyn.task.internal.core.wsdl.soap.v2.TrackerFieldBindType binding) {
        this.binding = binding;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof TrackerField)) return false;
        ...
        _equals = true && 
            ...
            ((this.short_name==null && other.getShort_name()==null) || 
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(TrackerField.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://demo.tuleap.net/plugins/tracker/soap", "TrackerField"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://demo.tuleap.net/plugins/tracker/soap", "TrackerFieldBindValue"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("binding");
        elemField.setXmlName(new javax.xml.namespace.QName("", "binding"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://demo.tuleap.net/plugins/tracker/soap", "TrackerFieldBindType"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();

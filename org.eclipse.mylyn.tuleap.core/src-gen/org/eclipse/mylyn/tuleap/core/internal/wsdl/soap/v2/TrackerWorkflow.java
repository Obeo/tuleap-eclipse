...
public class TrackerWorkflow  implements java.io.Serializable {
    ...
    private org.eclipse.mylyn.tuleap.core.internal.wsdl.soap.v2.TrackerWorkflowRuleArray rules;

    private org.eclipse.mylyn.tuleap.core.internal.wsdl.soap.v2.TrackerWorkflowTransition[] transitions;
    ...
    public TrackerWorkflow(
           int field_id,
           int is_used,
           org.eclipse.mylyn.tuleap.core.internal.wsdl.soap.v2.TrackerWorkflowRuleArray rules,
           org.eclipse.mylyn.tuleap.core.internal.wsdl.soap.v2.TrackerWorkflowTransition[] transitions) {
     ...
     * @return rules
     */
    public org.eclipse.mylyn.tuleap.core.internal.wsdl.soap.v2.TrackerWorkflowRuleArray getRules() {
        return rules;
    }
     ...
     * @param rules
     */
    public void setRules(org.eclipse.mylyn.tuleap.core.internal.wsdl.soap.v2.TrackerWorkflowRuleArray rules) {
        this.rules = rules;
    }
     ...
     * @return transitions
     */
    public org.eclipse.mylyn.tuleap.core.internal.wsdl.soap.v2.TrackerWorkflowTransition[] getTransitions() {
        return transitions;
    }
     ...
     * @param transitions
     */
    public void setTransitions(org.eclipse.mylyn.tuleap.core.internal.wsdl.soap.v2.TrackerWorkflowTransition[] transitions) {
        this.transitions = transitions;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://tuleap.net/plugins/tracker/soap", "TrackerWorkflow"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://tuleap.net/plugins/tracker/soap", "TrackerWorkflowRuleArray"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("transitions");
        elemField.setXmlName(new javax.xml.namespace.QName("", "transitions"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://tuleap.net/plugins/tracker/soap", "TrackerWorkflowTransition"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }

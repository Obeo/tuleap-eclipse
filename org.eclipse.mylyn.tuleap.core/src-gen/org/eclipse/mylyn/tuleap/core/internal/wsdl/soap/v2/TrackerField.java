...
public class TrackerField  implements java.io.Serializable {
    ...
    private org.eclipse.mylyn.tuleap.core.internal.wsdl.soap.v2.TrackerFieldBindValue[] values;

    private org.eclipse.mylyn.tuleap.core.internal.wsdl.soap.v2.TrackerFieldBindType binding;
    ...
    public TrackerField(
           ...
           org.eclipse.mylyn.tuleap.core.internal.wsdl.soap.v2.TrackerFieldBindValue[] values,
           org.eclipse.mylyn.tuleap.core.internal.wsdl.soap.v2.TrackerFieldBindType binding,
     ...
     * @return values
     */
    public org.eclipse.mylyn.tuleap.core.internal.wsdl.soap.v2.TrackerFieldBindValue[] getValues() {
        return values;
    }
     ...
     * @param values
     */
    public void setValues(org.eclipse.mylyn.tuleap.core.internal.wsdl.soap.v2.TrackerFieldBindValue[] values) {
        this.values = values;
    }
     ...
     * @return binding
     */
    public org.eclipse.mylyn.tuleap.core.internal.wsdl.soap.v2.TrackerFieldBindType getBinding() {
        return binding;
    }
     ...
     * @param binding
     */
    public void setBinding(org.eclipse.mylyn.tuleap.core.internal.wsdl.soap.v2.TrackerFieldBindType binding) {
        this.binding = binding;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://tuleap.net/plugins/tracker/soap", "TrackerField"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://tuleap.net/plugins/tracker/soap", "TrackerFieldBindType"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();

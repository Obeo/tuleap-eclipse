...
public class TrackerSemantic  implements java.io.Serializable {
    private org.eclipse.mylyn.tuleap.core.internal.wsdl.soap.v2.TrackerSemanticTitle title;

    private org.eclipse.mylyn.tuleap.core.internal.wsdl.soap.v2.TrackerSemanticStatus status;

    private org.eclipse.mylyn.tuleap.core.internal.wsdl.soap.v2.TrackerSemanticContributor contributor;

    private org.eclipse.mylyn.tuleap.core.internal.wsdl.soap.v2.AgileDashBoardSemanticInitialEffort initial_effort;

    public TrackerSemantic() {
    }

    public TrackerSemantic(
           org.eclipse.mylyn.tuleap.core.internal.wsdl.soap.v2.TrackerSemanticTitle title,
           org.eclipse.mylyn.tuleap.core.internal.wsdl.soap.v2.TrackerSemanticStatus status,
           org.eclipse.mylyn.tuleap.core.internal.wsdl.soap.v2.TrackerSemanticContributor contributor,
           org.eclipse.mylyn.tuleap.core.internal.wsdl.soap.v2.AgileDashBoardSemanticInitialEffort initial_effort) {
           this.title = title;
           this.status = status;
     ...
     * @return title
     */
    public org.eclipse.mylyn.tuleap.core.internal.wsdl.soap.v2.TrackerSemanticTitle getTitle() {
        return title;
    }
     ...
     * @param title
     */
    public void setTitle(org.eclipse.mylyn.tuleap.core.internal.wsdl.soap.v2.TrackerSemanticTitle title) {
        this.title = title;
    }
     ...
     * @return status
     */
    public org.eclipse.mylyn.tuleap.core.internal.wsdl.soap.v2.TrackerSemanticStatus getStatus() {
        return status;
    }
     ...
     * @param status
     */
    public void setStatus(org.eclipse.mylyn.tuleap.core.internal.wsdl.soap.v2.TrackerSemanticStatus status) {
        this.status = status;
    }
     ...
     * @return contributor
     */
    public org.eclipse.mylyn.tuleap.core.internal.wsdl.soap.v2.TrackerSemanticContributor getContributor() {
        return contributor;
    }
     ...
     * @param contributor
     */
    public void setContributor(org.eclipse.mylyn.tuleap.core.internal.wsdl.soap.v2.TrackerSemanticContributor contributor) {
        this.contributor = contributor;
    }
     ...
     */
    public org.eclipse.mylyn.tuleap.core.internal.wsdl.soap.v2.AgileDashBoardSemanticInitialEffort getInitial_effort() {
        return initial_effort;
    }
     ...
     */
    public void setInitial_effort(org.eclipse.mylyn.tuleap.core.internal.wsdl.soap.v2.AgileDashBoardSemanticInitialEffort initial_effort) {
        this.initial_effort = initial_effort;
    }

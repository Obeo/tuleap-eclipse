...
public class TrackerDesc implements java.io.Serializable {
	...
	public TrackerDesc(int group_artifact_id, int group_id, java.lang.String name,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = true
				...
				&& (this.reports_desc == null && other.getReports_desc() == null || this.reports_desc != null
	...
	public synchronized int hashCode() {
		...
		if (getReports_desc() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getReports_desc()); i++) {

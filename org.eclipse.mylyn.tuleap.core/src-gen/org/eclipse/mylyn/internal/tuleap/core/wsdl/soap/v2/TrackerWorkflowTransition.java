...
public class TrackerWorkflowTransition implements java.io.Serializable {
	...
	public TrackerWorkflowTransition(int from_id, int to_id) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof TrackerWorkflowTransition))
			return false;
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && this.from_id == other.getFrom_id() && this.to_id == other.getTo_id();
		__equalsCalc = null;
		return _equals;
	}
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			TrackerWorkflowTransition.class, true);

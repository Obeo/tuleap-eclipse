...
public class TrackerWorkflow implements java.io.Serializable {
	...
	private org.eclipse.mylyn.internal.tuleap.core.wsdl.soap.v2.TrackerWorkflowRuleArray rules;

	private org.eclipse.mylyn.internal.tuleap.core.wsdl.soap.v2.TrackerWorkflowTransition[] transitions;

	public TrackerWorkflow() {
	}

	public TrackerWorkflow(int field_id, int is_used,
			org.eclipse.mylyn.internal.tuleap.core.wsdl.soap.v2.TrackerWorkflowRuleArray rules,
			org.eclipse.mylyn.internal.tuleap.core.wsdl.soap.v2.TrackerWorkflowTransition[] transitions) {
	 ...
	 * @return rules
	 */
	public org.eclipse.mylyn.internal.tuleap.core.wsdl.soap.v2.TrackerWorkflowRuleArray getRules() {
		return rules;
	}
	 ...
	 * @param rules
	 */
	public void setRules(org.eclipse.mylyn.internal.tuleap.core.wsdl.soap.v2.TrackerWorkflowRuleArray rules) {
		this.rules = rules;
	}
	 ...
	 * @return transitions
	 */
	public org.eclipse.mylyn.internal.tuleap.core.wsdl.soap.v2.TrackerWorkflowTransition[] getTransitions() {
		return transitions;
	}
	...
	public synchronized int hashCode() {
		...
		if (getTransitions() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getTransitions()); i++) {

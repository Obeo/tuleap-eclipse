...
public class ItemInfo implements java.io.Serializable {
	...
	public ItemInfo(int id, int parent_id, java.lang.String title, java.lang.String filename,
			java.lang.String type, int nb_versions) {
		this.id = id;
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = true
				...
				&& (this.type == null && other.getType() == null || this.type != null
						&& this.type.equals(other.getType())) && this.nb_versions == other.getNb_versions();
		__equalsCalc = null;
		return _equals;
	}

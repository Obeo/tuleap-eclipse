...
public class Metadata implements java.io.Serializable {
	...
	public Metadata(java.lang.String label, java.lang.String name, java.lang.String type,
			int isMultipleValuesAllowed, int isEmptyAllowed,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = true
				...
				&& (this.listOfValues == null && other.getListOfValues() == null || this.listOfValues != null
	...
	public synchronized int hashCode() {
		...
		if (getListOfValues() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getListOfValues()); i++) {

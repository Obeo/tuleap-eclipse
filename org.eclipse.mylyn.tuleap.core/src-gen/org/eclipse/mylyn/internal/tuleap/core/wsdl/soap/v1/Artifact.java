...
public class Artifact implements java.io.Serializable {
	...
	public Artifact(int artifact_id, int group_artifact_id, int status_id, int submitted_by, int open_date,
			int close_date, int last_update_date, java.lang.String summary, java.lang.String details,
			int severity,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = true
				...
				&& (this.summary == null && other.getSummary() == null || this.summary != null
						&& this.summary.equals(other.getSummary()))
				&& (this.details == null && other.getDetails() == null || this.details != null
						&& this.details.equals(other.getDetails()))
				&& this.severity == other.getSeverity()
				&& (this.extra_fields == null && other.getExtra_fields() == null || this.extra_fields != null
	...
	public synchronized int hashCode() {
		...
		if (getExtra_fields() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getExtra_fields()); i++) {

...
public class ArtifactFollowup implements java.io.Serializable {
	...
	public ArtifactFollowup(int artifact_id, int follow_up_id, java.lang.String comment, int date,
			int original_date, java.lang.String by, java.lang.String original_by, int comment_type_id,
			java.lang.String comment_type, java.lang.String field_name, int user_can_edit) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArtifactFollowup)) {
			return false;
		}
		...
		_equals = true
				...
				&& (this.comment == null && other.getComment() == null || this.comment != null
						&& this.comment.equals(other.getComment()))
				&& this.date == other.getDate()
				&& this.original_date == other.getOriginal_date()
				&& (this.by == null && other.getBy() == null || this.by != null
						&& this.by.equals(other.getBy()))
				&& (this.original_by == null && other.getOriginal_by() == null || this.original_by != null
						&& this.original_by.equals(other.getOriginal_by()))
				&& this.comment_type_id == other.getComment_type_id()
				&& (this.comment_type == null && other.getComment_type() == null || this.comment_type != null

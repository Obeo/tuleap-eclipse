...
public class ArtifactField implements java.io.Serializable {
	...
	private org.eclipse.mylyn.internal.tuleap.core.wsdl.soap.v1.ArtifactFieldValueList[] available_values;
	...
	public ArtifactField(int field_id, int group_artifact_id, int field_set_id, java.lang.String field_name,
			int data_type, java.lang.String display_type, java.lang.String display_size,
			java.lang.String label, java.lang.String description, java.lang.String scope, int required,
			int empty_ok, int keep_history, int special, java.lang.String value_function,
			org.eclipse.mylyn.internal.tuleap.core.wsdl.soap.v1.ArtifactFieldValueList[] available_values,
			java.lang.String default_value, boolean user_can_submit, boolean user_can_update,
			boolean user_can_read, boolean is_standard_field) {
	 ...
	 */
	public org.eclipse.mylyn.internal.tuleap.core.wsdl.soap.v1.ArtifactFieldValueList[] getAvailable_values() {
		return available_values;
	}
	 ...
	 */
	public void setAvailable_values(
			org.eclipse.mylyn.internal.tuleap.core.wsdl.soap.v1.ArtifactFieldValueList[] available_values) {
		this.available_values = available_values;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArtifactField)) {
			return false;
		}
		...
		_equals = true
				...
				&& (this.field_name == null && other.getField_name() == null || this.field_name != null
						&& this.field_name.equals(other.getField_name()))
				&& this.data_type == other.getData_type()
				&& (this.display_type == null && other.getDisplay_type() == null || this.display_type != null
						&& this.display_type.equals(other.getDisplay_type()))
				&& (this.display_size == null && other.getDisplay_size() == null || this.display_size != null
				...
				&& (this.value_function == null && other.getValue_function() == null || this.value_function != null
						&& this.value_function.equals(other.getValue_function()))
				&& (this.available_values == null && other.getAvailable_values() == null || this.available_values != null
						&& java.util.Arrays.equals(this.available_values, other.getAvailable_values()))
				&& (this.default_value == null && other.getDefault_value() == null || this.default_value != null
	...
	public synchronized int hashCode() {
		...
		if (getAvailable_values() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getAvailable_values()); i++) {
	...
	static {
		...
		elemField.setXmlType(new javax.xml.namespace.QName("https://demo.tuleap.net",

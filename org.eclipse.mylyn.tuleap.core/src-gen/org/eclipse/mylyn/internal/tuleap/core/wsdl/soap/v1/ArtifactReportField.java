...
public class ArtifactReportField implements java.io.Serializable {
	...
	public ArtifactReportField(int report_id, java.lang.String field_name, int show_on_query,
			int show_on_result, int place_query, int place_result, int col_width) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArtifactReportField)) {
			return false;
		}
		...
		_equals = true
				...
				&& this.place_query == other.getPlace_query() && this.place_result == other.getPlace_result()
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArtifactReportField.class, true);

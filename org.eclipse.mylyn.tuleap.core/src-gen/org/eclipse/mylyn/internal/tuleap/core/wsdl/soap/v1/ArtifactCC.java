...
public class ArtifactCC implements java.io.Serializable {
	...
	public ArtifactCC(int artifact_cc_id, int artifact_id, java.lang.String email, int added_by,
			java.lang.String added_by_name, java.lang.String comment, int date) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = true
				...
				&& (this.added_by_name == null && other.getAdded_by_name() == null || this.added_by_name != null
						&& this.added_by_name.equals(other.getAdded_by_name()))
				&& (this.comment == null && other.getComment() == null || this.comment != null
						&& this.comment.equals(other.getComment())) && this.date == other.getDate();
		__equalsCalc = null;
		return _equals;
	}

...
public class ArtifactQueryResult  implements java.io.Serializable {
    ...
    private org.eclipse.mylyn.internal.tuleap.core.wsdl.soap.v2.Artifact[] artifacts;
    ...
    public ArtifactQueryResult(
           ...
           org.eclipse.mylyn.internal.tuleap.core.wsdl.soap.v2.Artifact[] artifacts) {
     ...
     * @return artifacts
     */
    public org.eclipse.mylyn.internal.tuleap.core.wsdl.soap.v2.Artifact[] getArtifacts() {
        return artifacts;
    }
     ...
     * @param artifacts
     */
    public void setArtifacts(org.eclipse.mylyn.internal.tuleap.core.wsdl.soap.v2.Artifact[] artifacts) {
        this.artifacts = artifacts;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://demo.tuleap.net/plugins/tracker/soap", "ArtifactQueryResult"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://demo.tuleap.net/plugins/tracker/soap", "Artifact"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }

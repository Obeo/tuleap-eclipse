...
public class FRSPackage implements java.io.Serializable {
	...
	public FRSPackage(int package_id, int group_id, java.lang.String name, int status_id, int rank,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = true
				...
				&& (this.name == null && other.getName() == null || this.name != null
						&& this.name.equals(other.getName())) && this.status_id == other.getStatus_id()
				&& this.rank == other.getRank() && this.approve_license == other.isApprove_license();
		__equalsCalc = null;
		return _equals;
	}

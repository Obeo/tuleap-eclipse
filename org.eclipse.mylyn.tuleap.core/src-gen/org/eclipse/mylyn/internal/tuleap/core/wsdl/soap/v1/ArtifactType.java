...
public class ArtifactType implements java.io.Serializable {
	...
	private org.eclipse.mylyn.internal.tuleap.core.wsdl.soap.v1.ArtifactFieldSet[] field_sets;

	private org.eclipse.mylyn.internal.tuleap.core.wsdl.soap.v1.ArtifactRule[] field_dependencies;

	public ArtifactType() {
	}

	public ArtifactType(int group_artifact_id, int group_id, java.lang.String name,
			java.lang.String description, java.lang.String item_name, int open_count, int total_count,
			float total_file_size,
			org.eclipse.mylyn.internal.tuleap.core.wsdl.soap.v1.ArtifactFieldSet[] field_sets,
			org.eclipse.mylyn.internal.tuleap.core.wsdl.soap.v1.ArtifactRule[] field_dependencies) {
	 ...
	 * @return field_sets
	 */
	public org.eclipse.mylyn.internal.tuleap.core.wsdl.soap.v1.ArtifactFieldSet[] getField_sets() {
		return field_sets;
	}
	 ...
	 */
	public org.eclipse.mylyn.internal.tuleap.core.wsdl.soap.v1.ArtifactRule[] getField_dependencies() {
		return field_dependencies;
	}
	 ...
	 */
	public void setField_dependencies(
			org.eclipse.mylyn.internal.tuleap.core.wsdl.soap.v1.ArtifactRule[] field_dependencies) {
		this.field_dependencies = field_dependencies;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = true
				...
				&& (this.field_sets == null && other.getField_sets() == null || this.field_sets != null
						&& java.util.Arrays.equals(this.field_sets, other.getField_sets()))
				&& (this.field_dependencies == null && other.getField_dependencies() == null || this.field_dependencies != null
	...
	public synchronized int hashCode() {
		...
		if (getField_sets() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getField_sets()); i++) {
		...
		if (getField_dependencies() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getField_dependencies()); i++) {

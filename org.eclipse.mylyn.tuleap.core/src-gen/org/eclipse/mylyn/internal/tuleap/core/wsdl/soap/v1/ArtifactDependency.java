...
public class ArtifactDependency implements java.io.Serializable {
	...
	public ArtifactDependency(int artifact_depend_id, int artifact_id, int is_dependent_on_artifact_id,
			java.lang.String summary, int tracker_id, java.lang.String tracker_name, int group_id,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = true
				...
				&& (this.tracker_name == null && other.getTracker_name() == null || this.tracker_name != null
						&& this.tracker_name.equals(other.getTracker_name()))
				&& this.group_id == other.getGroup_id()
				&& (this.group_name == null && other.getGroup_name() == null || this.group_name != null

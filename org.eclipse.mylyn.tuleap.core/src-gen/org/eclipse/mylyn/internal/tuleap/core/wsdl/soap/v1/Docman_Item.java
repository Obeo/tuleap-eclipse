...
public class Docman_Item implements java.io.Serializable {
	...
	public Docman_Item(int item_id, int parent_id, int group_id, java.lang.String title,
			java.lang.String description, int create_date, int update_date, int delete_date, int user_id,
			int status, int obsolescence_date, int rank, int item_type) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = true
				...
				&& this.create_date == other.getCreate_date() && this.update_date == other.getUpdate_date()
				&& this.delete_date == other.getDelete_date() && this.user_id == other.getUser_id()
				&& this.status == other.getStatus() && this.obsolescence_date == other.getObsolescence_date()
				&& this.rank == other.getRank() && this.item_type == other.getItem_type();
		__equalsCalc = null;
		return _equals;
	}

...
public class ArtifactFromReportResult implements java.io.Serializable {
	...
	private org.eclipse.mylyn.internal.tuleap.core.wsdl.soap.v1.ArtifactFromReport[] artifacts;

	public ArtifactFromReportResult() {
	}

	public ArtifactFromReportResult(int total_artifacts_number,
			org.eclipse.mylyn.internal.tuleap.core.wsdl.soap.v1.ArtifactFromReport[] artifacts) {
	 ...
	 * @return artifacts
	 */
	public org.eclipse.mylyn.internal.tuleap.core.wsdl.soap.v1.ArtifactFromReport[] getArtifacts() {
		return artifacts;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArtifactFromReportResult)) {
			return false;
		}
		...
		_equals = true
				...
				&& (this.artifacts == null && other.getArtifacts() == null || this.artifacts != null
	...
	public synchronized int hashCode() {
		...
		if (getArtifacts() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getArtifacts()); i++) {
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArtifactFromReportResult.class, true);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("https://demo.tuleap.net",
		...
		elemField.setXmlType(new javax.xml.namespace.QName("https://demo.tuleap.net", "ArtifactFromReport"));
		elemField.setNillable(false);
		typeDesc.addFieldDesc(elemField);
	}

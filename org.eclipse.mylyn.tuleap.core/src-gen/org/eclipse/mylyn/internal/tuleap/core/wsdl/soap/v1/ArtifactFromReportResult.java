...
public class ArtifactFromReportResult  implements java.io.Serializable {
     ...
     * @param artifacts
     */
    public void setArtifacts(org.eclipse.mylyn.internal.tuleap.core.wsdl.soap.v1.ArtifactFromReport[] artifacts) {
        this.artifacts = artifacts;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://demo.tuleap.net", "ArtifactFromReportResult"));

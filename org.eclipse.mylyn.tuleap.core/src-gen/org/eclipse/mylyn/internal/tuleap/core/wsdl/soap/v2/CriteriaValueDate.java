...
public class CriteriaValueDate implements java.io.Serializable {
	...
	public CriteriaValueDate(java.lang.String op, int to_date) {
		this.op = op;
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof CriteriaValueDate)) {
			return false;
		}
		...
		boolean _equals;
		_equals = true
				&& (this.op == null && other.getOp() == null || this.op != null
						&& this.op.equals(other.getOp())) && this.to_date == other.getTo_date();
		__equalsCalc = null;
		return _equals;
	}

 ...
 *******************************************************************************/
package org.eclipse.mylyn.tuleap.ui.task.internal.util;
...
public class TuleapUiMessagesKeys extends NLS {
	...
	/**
	 * The message displayed while the validation of the connection is in
	 * progress.
	 */
	...
	/**
	 * The label of the combo used to select the field to which the attachment
	 * will be added.
	 */
	...
	/**
	 * Label used for missing agile connector when attempting to create a
	 * TaskDataModel.
	 */

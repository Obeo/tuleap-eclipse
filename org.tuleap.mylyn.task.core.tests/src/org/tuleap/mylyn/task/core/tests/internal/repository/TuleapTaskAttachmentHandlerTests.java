...
import org.tuleap.mylyn.task.core.internal.repository.TuleapTaskAttachmentHandler;
...
public class TuleapTaskAttachmentHandlerTests {
	...
	public void setUp() {
		...
		client = new TuleapRestClient(restResourceFactory, gson, repository) {
			...
			@Override
			public void updateArtifactAttachments(TuleapArtifactWithAttachment artifact,
		...
		repositoryConnector = new ITuleapRepositoryConnector() {
			...
			@Override
			public void refreshProject(TaskRepository taskRepository, TuleapProject prj,
					IProgressMonitor monitor) throws CoreException {
				// Nothing to do here
			}

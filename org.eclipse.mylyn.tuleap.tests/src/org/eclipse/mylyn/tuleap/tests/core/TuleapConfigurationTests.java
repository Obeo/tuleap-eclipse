...
public class TuleapConfigurationTests extends TestCase {
	...
	public void testRepositoryConfigurationStructuralElements() {
		...
		this.check(fieldset, "F1", "Details", "fieldset_1", "fieldset_default_tasks_desc_key", true, -1); //$NON-NLS-1$//$NON-NLS-2$//$NON-NLS-3$//$NON-NLS-4$

		AbstractTuleapFormElement fieldset2 = config.getFormElements().get(1);
		assertEquals(TuleapFieldSet.class, fieldset2.getClass());
		this.check(fieldset2, "F6", "State of Progress", "fieldset_2", null, true, -1); //$NON-NLS-1$//$NON-NLS-2$//$NON-NLS-3$

		AbstractTuleapFormElement fieldset3 = config.getFormElements().get(2);
		assertEquals(TuleapFieldSet.class, fieldset3.getClass());
		this.check(fieldset3, "F16", "Fieldset", "fieldset", "Filedset description", false, -1); //$NON-NLS-1$//$NON-NLS-2$//$NON-NLS-3$//$NON-NLS-4$

		AbstractTuleapFormElement column = config.getFormElements().get(3);
		assertEquals(TuleapColumn.class, column.getClass());
		this.check(column, "F17", "Column", "column", "Column description", false, -1); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$

		AbstractTuleapFormElement linebreak = config.getFormElements().get(4);
		assertEquals(TuleapLineBreak.class, linebreak.getClass());
		this.check(linebreak, "F18", "Line Break", "line_break", null, false, -1); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$

		AbstractTuleapFormElement separator = config.getFormElements().get(5);
		assertEquals(TuleapSeparator.class, separator.getClass());
		this.check(separator, "F19", "Separator", "separator", null, false, -1); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$

		AbstractTuleapFormElement staticText = config.getFormElements().get(6);
		assertEquals(TuleapStaticText.class, staticText.getClass());
		this.check(staticText, "F20", "Static text", "static_text", "Static text description", false, -1); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$

		AbstractTuleapFormElement fieldset0 = config.getFormElements().get(7);
		assertEquals(TuleapFieldSet.class, fieldset0.getClass());
		this.check(fieldset0, "F21", "Fieldset0", "fieldset0", "Fieldset0 description", false, -1); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
		...
		this.check(fieldset1, "F22", "Fieldset1", "fieldset1_11", "Fieldset1 description", false, -1); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
		...
		this.check(column11, "F23", "Column1.1", "column11", "Column1.1 description", false, -1); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
		...
		this.check(column121, "F25", "Column1.2.1", "column121", "Column1.2.1 description", false, -1); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
	...
	public void testRepositoryConfigurationFields() {
		...
		this.check(string, "F27", "String", "string", "String description", true, -1); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
		...
		this.check(text, "F28", "Text", "text", "Text description", false, -1); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
		...
		this.check(selectBox, "F29", "SelectBox", "selectbox", "SelectBox description", false, -1); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
		...
		assertEquals("A", ((TuleapSelectBox)selectBox).getItems().get(0).getLabel()); //$NON-NLS-1$
		assertEquals("B", ((TuleapSelectBox)selectBox).getItems().get(1).getLabel()); //$NON-NLS-1$
		assertEquals("C", ((TuleapSelectBox)selectBox).getItems().get(2).getLabel()); //$NON-NLS-1$
		assertEquals("D", ((TuleapSelectBox)selectBox).getItems().get(3).getLabel()); //$NON-NLS-1$
		assertEquals("E", ((TuleapSelectBox)selectBox).getItems().get(4).getLabel()); //$NON-NLS-1$
		assertEquals("F", ((TuleapSelectBox)selectBox).getItems().get(5).getLabel()); //$NON-NLS-1$
		...
		this.check(date, "F31", "Date", "date", "Date description", false, -1); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$

		AbstractTuleapFormElement file = config.getFormElements().get(13);
		assertEquals(TuleapFileUpload.class, file.getClass());
		this.check(file, "F32", "FileUpload", "fileupload", "FileUpload description", false, -1); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$

		AbstractTuleapFormElement integer = config.getFormElements().get(14);
		assertEquals(TuleapInteger.class, integer.getClass());
		this.check(integer, "F33", "Integer", "integer", "Integer description", true, -1); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$

		AbstractTuleapFormElement floatField = config.getFormElements().get(15);
		assertEquals(TuleapFloat.class, floatField.getClass());
		this.check(floatField, "F34", "Float", "float", "Float description", false, -1); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$

		AbstractTuleapFormElement openList = config.getFormElements().get(16);
		assertEquals(TuleapOpenList.class, openList.getClass());
		this.check(openList, "F35", "OpenList", "openlist", "OpenList description", false, -1); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
		...
		this.check(artefactLink, "F36", "ArtifactLink", "artifactlink", "ArtifactLink description", false, -1); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
		...
		this.check(permission, "F37", "Permission", "permission_1", "Permission description", false, -1); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
	}
	...
	public void testRepositoryConfigurationSemantic() {
		...
		if (abstractTuleapFormElement instanceof TuleapColumn) {
			...
			if (abstractTuleapField instanceof TuleapSelectBox) {
				...
				List<TuleapSelectBoxItem> openStatus = tuleapSelectBox.getOpenStatus();
				List<String> openStatusStr = new ArrayList<String>();
				for (TuleapSelectBoxItem item : openStatus) {
					openStatusStr.add(item.getLabel());
				}
				assertTrue(openStatusStr.contains("Open")); //$NON-NLS-1$
				assertTrue(openStatusStr.contains("Verified")); //$NON-NLS-1$
				assertTrue(openStatusStr.contains("Reopened")); //$NON-NLS-1$
				assertTrue(openStatusStr.contains("Assigned")); //$NON-NLS-1$

				List<TuleapSelectBoxItem> closedStatus = tuleapSelectBox.getClosedStatus();
				List<String> closedStatusStr = new ArrayList<String>();
				for (TuleapSelectBoxItem item : closedStatus) {
					closedStatusStr.add(item.getLabel());
				}
				assertTrue(closedStatusStr.contains("Closed")); //$NON-NLS-1$
			} else {
				fail();
			}
		} else {
